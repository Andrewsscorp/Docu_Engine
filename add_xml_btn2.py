...
import re
old_block = r'(<div class="bg-slate-50 group-hover:bg-white p-2 rounded-lg border border-slate-200 font-mono text-\[10px\] text-slate-400 break-all transition-colors">\s*Tx: \{\{ ev\.firma_indice \}\}\s*</div>)'
