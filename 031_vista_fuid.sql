DROP MATERIALIZED VIEW IF EXISTS vista_fuid_detalle_subserie;
...
CREATE UNIQUE INDEX idx_fuid_codigo ON vista_fuid_detalle_subserie (codigo);
CREATE INDEX idx_fuid_subserie ON vista_fuid_detalle_subserie (subserie_id);
